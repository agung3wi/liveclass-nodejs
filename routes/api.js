...
router.get('/customer', CustomerApiController.index)
router.get('/customer/:id', CustomerApiController.detail)
router.post('/customer/add', CustomerApiController.store)
router.post('/customer/edit/:id', CustomerApiController.update)
router.get('/customer/delete/:id', CustomerApiController.delete)
